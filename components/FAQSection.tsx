...
export default function FAQSection({ currentLang, setTab, isFullPage = false }: FAQSectionProps) {
  ...
  return (
    <section id="faq-section" className={`bg-white py-20 ${isFullPage ? 'min-h-screen py-24' : ''}`}>
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        ...
        <div id="faq-search-row" className="relative w-full max-w-md mx-auto mb-12">
          ...
          <input
            ...
            className="w-full rounded-xl border border-gray-200 bg-white px-11 py-3.5 text-sm text-gray-800 placeholder-gray-400 shadow-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
          />
        </div>
        ...
        {filteredFAQs.length > 0 ? (
            ...
            {filteredFAQs.map((faq) => {
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl border bg-white p-5 cursor-pointer transition duration-300 ${
                    isExpanded
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex items-center space-x-3 text-left">
                      <HelpCircle className={`h-5 w-5 shrink-0 transition duration-300 ${isExpanded ? 'text-blue-500' : 'text-gray-400'}`} />
                  ...
                  {isExpanded && (
                    <div className="mt-4 pt-4 border-t border-gray-50 space-y-4">
                      ...
                      <div className="flex items-center justify-between text-[10px] font-semibold text-gray-400 pt-2">
                        <span className="rounded bg-white border border-gray-200 px-2 py-0.5 uppercase tracking-wider">
          ...
          <div id="faq-empty-state" className="text-center py-16 border border-dashed border-gray-200 rounded-2xl max-w-md mx-auto">
        ...
        <div id="faq-footer-banner" className="mt-16 text-center bg-[#FAFAFA] border border-gray-100 p-6 rounded-2xl space-y-4">
          <h4 className="text-base font-bold text-gray-900 flex items-center justify-center gap-1.5">
